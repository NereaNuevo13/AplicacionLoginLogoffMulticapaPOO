...
CREATE TABLE IF NOT EXISTS DAW214DBProyectoTema5.T02_Departamento(
...
CREATE TABLE IF NOT EXISTS DAW214DBProyectoTema5.T01_Usuario(
...
CREATE USER 'usuarioDAW214DBProyectoTema5'@'%' IDENTIFIED BY 'paso';
